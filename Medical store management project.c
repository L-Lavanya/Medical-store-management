#include<stdio.h>
 ...
 main()
 {
  ...
  strcpy(m[i].Exp_Date,"");
   ...
   m[0].price=120;
   m[0].quantity=30;
   strcpy(m[0].Mfg_Date,"03-05-2022");
  strcpy(m[0].Exp_Date,"02-05-2026");
   strcpy(m[0].medicneName,"Dolo650");
   strcpy(m[0].Company,"xyz");
   ...
   switch(choice)
   {
     ...
     case 2:
    {
     ...
     printf("To Continue with other Options Enter 1\n Else any other number\n");
     scanf("%d",&c);
   }while(c==1);
